...
do
	...
	#run dcm2bids.
	dcm2bids -d ~/netshare/SYNVETSACOPY/data/vetsa/VETSA3_orig/orig/${vetsaid}_v3/ -p ${vetsaid} -s ses-03 -c ~/netshare/M/MRI/BIDS/code/dcm2bids_config_v3.json -o ~/netshare/M/MRI/BIDS/data/
